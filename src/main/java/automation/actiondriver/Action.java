 ...
 * 
 */
package automation.actiondriver;
...
import automation.actioninterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	...
	Log.info(" click on elemet");	

	}

	@Override
	public void clickitem(WebDriver driver, WebElement ele) {
		Actions act = new Actions(driver);
try {
	act.wait(5000);
	...
	public boolean isDisplayed(WebDriver driver, WebElement ele) {
		...
		if (flag) {
			...
			if (flag) {
				...
				System.out.println("The element Text is "+ele.getText());
			} else {
	...
	@Override
	public boolean validateText(String visibletext, WebElement ele) {
		boolean flag = false;
		try {
//			Select s = new Select(ele);
//			s.selectByVisibleText(visibletext);
			SoftAssert softAssert = new SoftAssert();
			String accountInfo = ele.getText();
			System.out.println("text///////////" + accountInfo);
			softAssert.assertNotNull(accountInfo);
			Assert.assertEquals(accountInfo, visibletext);
			...
			if (flag) {
				System.out.println("same text is valid ");
			} else {
